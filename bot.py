        ...
        if usr_cmd == "/start":
            ...
            if(Config.LAZY_MODE == True):
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton("🍿supp⊕r†", url="https://t.me/HELL_GaM"),
                            InlineKeyboardButton("🔊chαηηεl", url="https://t.me/HELL_GaM")
                        ],
                        [
                        ...
                        [
                            InlineKeyboardButton("⎝⎝✧✧ ᴡᴀᴛᴄʜ ✧✧⎠⎠", url="https://t.me/MM_Films")
                        ]]))
            else :
                await cmd.reply_photo(photo=lazy_pic,
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton("🍿supp⊕r† gr⊕up", url="https://t.me/HELL_GaM"),
                            InlineKeyboardButton("🔊ß⊕†s chαηηεl", url="https://t.me/HELL_GaM")
                        ],
                        [
                            InlineKeyboardButton("🤖Aß⊕ut ß⊕†", callback_data="aboutbot"),
                            InlineKeyboardButton("♥️Aß⊕ut Đ€V", callback_data="aboutdevs")
                        ...
                        [
                            InlineKeyboardButton("⎝⎝✧✧ ᴡᴀᴛᴄʜ ✧✧⎠⎠", url="https://t.me/HELL_GaM")
                        ]]))
        ...
        if "aboutbot" in cb_data:
            ...
            if(Config.LAZY_MODE == True):
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton("🍿supp⊕r† gr⊕up", url="https://t.me/MM_Films"),
                            InlineKeyboardButton("🔊ß⊕ts Channel", url="https://t.me/MM_Films")
                        ],
                        [
                            InlineKeyboardButton("🤖Aß⊕ut ß⊕t", callback_data="aboutbot"),
                            InlineKeyboardButton("♥️Aß⊕ut Đ€V", callback_data="aboutdevs")
